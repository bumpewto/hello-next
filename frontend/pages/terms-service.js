...
const TermsContent = () => (
  <>
    ...
    <p>
      ...
      <a href="https://atmo.com">https://atmo.com</a>, you are agreeing to be
    ...
    <ol type="a">
      <li>
        ...
        (information or software) on Atmo's website for personal, non-commercial
      ...
      <li>
        ...
        restrictions and may be terminated by Atmo at any time. Upon terminating
    ...
    <ol type="a">
      <li>
        The materials on Atmo's website are provided on an 'as is' basis. Atmo
      ...
      <li>
        Further, Atmo does not warrant or make any representations concerning
    ...
    <h3>4. Limitations</h3>
    <p>
      In no event shall Atmo or its suppliers be liable for any damages
      ...
      materials on Atmo's website, even if Atmo or a Atmo authorized
    ...
    <p>
      The materials appearing on Atmo's website could include technical,
      typographical, or photographic errors. Atmo does not warrant that any of
      the materials on its website are accurate, complete or current. Atmo may
      make changes to the materials contained on its website at any time without
      notice. However Atmo does not make any commitment to update the materials.
    </p>
    <h3>6. Links</h3>
    <p>
      Atmo has not reviewed all of the sites linked to its website and is not
      responsible for the contents of any such linked site. The inclusion of any
      link does not imply endorsement by Atmo of the site. Use of any such
      linked website is at the user's own risk.
    </p>
    <h3>7. Modifications</h3>
    <p>
      Atmo may revise these terms of service for its website at any time without
